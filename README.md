...
e-Mate 桌面应用的 `2.0.17` 是 [GitHub `e-Mate-desktop`](https://github.com/zyfjacksonchen-source/e-Mate-desktop) 的当前源码目标，基于固定 `@deepseek-ai/dsh@0.1.5-rc.1`、Harness `e841a5c4add3f7e34c3f7efc8742313debf54922` 与 `deepseek-harness-desktop@166c16cfc38c51d32c2316715548c0f8271db517`。稳定 Electron `productName`、应用名称和安装位置仍为 `e-Mate`；“Desktop”只描述桌面产品与仓库范围。这些身份只说明源码合同，不表示候选包、安装验收或公共发布已经完成。
