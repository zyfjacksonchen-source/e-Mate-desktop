...
function context() {
  return {
    ...
    provenance: { emate_commit: 'a'.repeat(40), harness_commit: '43c411a51c555e61e9b5f500442cb3404a2d70cd', desktop_reference: '166c16cfc38c51d32c2316715548c0f8271db517', version: '2.0.18' },
