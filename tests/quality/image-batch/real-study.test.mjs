...
function context() {
  return {
    ...
    provenance: { emate_commit: 'a'.repeat(40), harness_commit: 'e841a5c4add3f7e34c3f7efc8742313debf54922', desktop_reference: '166c16cfc38c51d32c2316715548c0f8271db517', version: '2.0.18' },
