...
function context() {
  return {
    ...
    provenance: { emate_commit: 'a'.repeat(40), harness_commit: 'bf7179bf3f62585d84b9b41b8cc1a0fffa1d7866', desktop_reference: '166c16cfc38c51d32c2316715548c0f8271db517', version: '2.0.18' },
