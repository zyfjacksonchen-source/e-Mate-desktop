...
function context() {
  return {
    ...
    provenance: { emate_commit: 'a'.repeat(40), harness_commit: 'd1d095bee770c3e9d302f844083e02f0b74576ee', desktop_reference: '166c16cfc38c51d32c2316715548c0f8271db517', version: '2.0.18' },
