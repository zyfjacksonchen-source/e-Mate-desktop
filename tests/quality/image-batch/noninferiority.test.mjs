...
function study({ count = 60, singleScore = 4, batchScore = 4 } = {}) {
  const record = {
    schema_version: 1,
    provenance: { emate_commit: 'a'.repeat(40), harness_commit: '7882599607eade325e66e7bf28f520a206270727', desktop_reference: '166c16cfc38c51d32c2316715548c0f8271db517', version: '2.0.17' },
