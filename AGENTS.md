...
The user directed the 0.1.5 migration onto the accepted baseline. Keep Harness 0.1.5-rc.1 at 43c411a51c555e61e9b5f500442cb3404a2d70cd and the native dsh-desktop reference. The Agent Loop must remain unmodified; image/Vision capabilities use native plugin/Tool interfaces. Preserve existing image reference, edit routing, terminal deduplication and recovery fixes carried over from the 0.1.5 migration tree.
