...
The user directed the 0.1.5 migration onto the accepted baseline. Keep Harness 0.1.5-rc.1 at bf7179bf3f62585d84b9b41b8cc1a0fffa1d7866 and the native dsh-desktop reference. The Agent Loop must remain unmodified; image/Vision capabilities use native plugin/Tool interfaces. Preserve existing image reference, edit routing, terminal deduplication and recovery fixes carried over from the 0.1.5 migration tree.
