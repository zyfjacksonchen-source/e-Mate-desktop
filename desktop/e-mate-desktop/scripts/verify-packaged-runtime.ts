...
export const REQUIRED_UNPACKED_RUNTIME_ENTRIES = [
  ...
  'node_modules/@deepseek-ai/dsh-agent-presets/presets/minimal/agent.cordis.yml',
  'node_modules/@deepseek-ai/dsh-agent-presets/presets/minimal/preset.yml',
  'node_modules/@deepseek-ai/dsh-agent-presets/presets/cordis/agent.cordis.yml',
  'node_modules/@deepseek-ai/dsh-agent-presets/presets/cordis/preset.yml',
