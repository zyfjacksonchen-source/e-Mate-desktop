...
- This project pins the DSH `0.1.5-rc.1` family used by `anywhere-labs/deepseek-harness-desktop@166c16cfc38c51d32c2316715548c0f8271db517`. e-Mate keeps its accepted 0.1.5 Harness fork commit while validating the same published Desktop ABI and lifecycle contracts.
