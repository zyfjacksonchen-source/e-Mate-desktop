...
- 本项目固定使用 `anywhere-labs/deepseek-harness-desktop@166c16cfc38c51d32c2316715548c0f8271db517` 对应的 DSH `0.1.5-rc.1` family。e-Mate 保留已验收的 0.1.5 Harness fork 提交，并校验相同的 Desktop ABI 与生命周期合同。
