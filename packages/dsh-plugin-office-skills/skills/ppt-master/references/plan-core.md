...
Everything here is a plan-only or Reference decision under [`ownership.md`](../upstream-reference/docs/rules/ownership.md): content, relationships, roster, rhythm, identity anchors, and resources bind; macro composition, motif, and pattern suggestions are References the Executor adjusts freely.
