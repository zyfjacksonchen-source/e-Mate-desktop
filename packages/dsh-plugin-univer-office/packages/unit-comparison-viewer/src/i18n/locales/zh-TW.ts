import editHistoryLocale from '@univerjs-pro/edit-history-ui/locale/zh-TW'
...
const semantic = createComparisonSemanticMessages(LocaleType.ZH_TW, editHistoryLocale)

export const zhTWUnitComparisonViewerMessages = {
  changes: '修改',
  ...
  noRawTableChanges: '無 表格 修改',
  rawTableData: '表格 · 內容',
  baseAlignmentHint: '列欄依穩定識別碼對齊',
  checkboxState: {
    checked: '已勾選',
    unchecked: '未勾選'
  },
